...
public interface RestClientCelcoin {
    ...
    String consult(@HeaderParam("Authorization") String token, ConsultarBoletoDTO dto);

    @POST
    @Path("/v5/transactions/billpayments")
    String payment(@HeaderParam("Authorization") String token, ConsultarBoletoDTO dto);
